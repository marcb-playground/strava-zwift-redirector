...
class StravaClient:
    ...
    strava_client_refresh_token = None
    ...
    def __init__(self, client_for):
        ...
        if client_for == "source":
            self.strava_client_id = os.getenv("STRAVA_SOURCE_CLIENT_ID")
            self.strava_client_secret = os.getenv("STRAVA_SOURCE_CLIENT_SECRET")
            self.strava_client_refresh_token = os.getenv("STRAVA_SOURCE_REFRESH_TOKEN")
            print("source info")
        ...
        self.strava_access_token = get_access_token(
            self.strava_client_id, self.strava_client_secret, self.strava_client_refresh_token
        )

        print("getting strava client")
        self.stravalib_client = stravalib.Client(access_token=self.strava_access_token)
